...
const gameData = [
  ...
  {value: 'bdsp', label: 'Pokemon Brilliant Diamond/Shining Pearl', abbr: 'BDSP', zoom: 1, path: 'other.sv-art'},
  {value: 'pla', label: 'Pokemon Legends Arceus', abbr: 'PLA', zoom: 1, path: 'other.sv-art'},
